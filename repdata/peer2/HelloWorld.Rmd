...
```{r download and sample data, echo=FALSE, results='hide'}
...
```{r data, cache=TRUE, echo=FALSE, message=FALSE}
library(data.table)
...
### Data cleansing
```{r colnames, results='hide', echo=FALSE}
library(data.table)
...
```{r damage calc, results='hide', echo=FALSE}
...
And these states have no reported damages: `r dmg.summary$STATE[zero.dmg]`
...
Many of the event types in the data set do not match the office list of event
names.  too many events; how about categories of events?
