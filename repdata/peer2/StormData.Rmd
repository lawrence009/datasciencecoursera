...
### Assessment of EVTYPE extraction
...
element.freq <- table(dts[, c('Region', 'Element1'), with=F])

element.freq

dmg.freq <- table(dts[(FATALITIES + INJURIES + PropDmg + CropDmg) > 0,
                      c('Region', 'Element1'), with=F])

dmg.freq

dmg.freq / element.freq
...
dts[, ':='(econ  =(PropDmg*lamda + CropDmg),
