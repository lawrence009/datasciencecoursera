...
## H~0~: There is no difference in the effect of two suppliments independent of dosage. 
...
```{r}
with(subset(ToothGrowth, dose == c(0.5, 2)), t.test(len~dose))
```
...
* Higher dosage, regardless of the source of vitamin C, suggest providing
