---
title: "Choosing the Appropriate Type of Charts to Summarize the Result"
...
the United States for 1999, 2002, 2005, and 2008 is used for this demonstration.
...
This chart might be okay except Los Angeles far higher number of observations
(data points):

```{r, echo=FALSE}
tapply(pm25$SCC, pm25$fips, length)
```
